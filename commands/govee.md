...
argument-hint: "status | styles [state] | set <state> --color RRGGBB ... | preview <state> | reset <state>|--all | save | revert | theme list|apply|save|install | devices | test <state> | on | off | refresh | restart | logs | doctor"
allowed-tools: ["Bash"]
---
